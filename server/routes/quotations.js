...
// Get next quotation number (Resets sequence to 1 at start of each Financial Year on April 1)
router.get('/next-number', async (req, res) => {
    try {
        ...
        // Get all quotations created within this financial year
        const result = await db.query(
            `SELECT quotation_number FROM quotations 
             WHERE user_id = $1 AND quotation_date::date >= $2::date AND quotation_date::date <= $3::date`,
