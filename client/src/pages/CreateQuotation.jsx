...
const CreateQuotation = () => {
    ...
    useEffect(() => {
        ...
        const fetchNextNumber = async () => {
            try {
                const res = await fetch(`${import.meta.env.VITE_API_URL}/api/quotations/next-number`, {
                            ...
                            <div key={item.id} className="p-4 md:p-6 bg-gray-50 rounded-2xl border border-gray-200 relative space-y-4 animate-fadeIn">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    ...
                                    {item.item_category === 'Other' && (
                                        <div className="md:col-span-2">
                                            <label className="block text-xs font-semibold text-gray-500 mb-1">Specify Details * (Blank space for details)</label>
                                            <input
                                                required
                                                type="text"
                                                className="w-full px-4 py-2 border border-gray-300 rounded-xl outline-none transition-all text-sm font-semibold"
                                                placeholder="Enter item name and specifications"
