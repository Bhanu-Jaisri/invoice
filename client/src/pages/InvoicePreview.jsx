                            ...
                            <div className="grid grid-cols-2 gap-4 mb-3">
                                <div>
                                    ...
                                    <div className="text-[10px] text-gray-700 leading-tight">
                                        <strong>Bank:</strong> {invoice.bank_name || 'TAMILNAD MERCANTILE BANK'}<br />
                                        <strong>Branch:</strong> {invoice.bank_branch || 'SIVAKASI'}<br />
                                        <strong>Account Name:</strong> {invoice.account_name || officeName}<br />
                                        <strong>A/c No:</strong> {invoice.account_no || '003150050802592'}<br />
                                        <strong>IFSC:</strong> {invoice.ifsc_code || 'TMBL0000003'}
                                    </div>
                                </div>
                                <div>
                                    <div className="text-[10px] text-primary font-bold uppercase mb-1">Terms And Conditions</div>
                                    <div className="text-[9px] text-gray-500 leading-tight whitespace-pre-line">
